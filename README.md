...
The Jev-compatible CLI, npm release, and self-contained production container
are maintained separately in [metalagman/layajev](https://github.com/metalagman/layajev).
This repository remains the reusable in-process `laya` library; it does not
own CLI model acquisition or an HTTP server.
...
The `layajev` npm release and operations are documented in
[metalagman/layajev](https://github.com/metalagman/layajev).
